...
class Torneo(models.Model):
    ...
    fecha_limite_participantes = models.DateTimeField(default=timezone.now)    
...
class AsignacionJuez(models.Model):
    ...
    juez = models.ForeignKey(Usuario, on_delete=models.CASCADE, limit_choices_to={'rol': 'juez'}, default=1)
